...
void memory_info(void) {
    ...
    vga_print("Memoire totale: ");
    // Note: Conversion simple pour affichage
    vga_print("32768 bytes\n");
    vga_print("Memoire utilisee: ");
    vga_print("4096 bytes\n");
    vga_print("Memoire libre: ");
    vga_print("28672 bytes\n");
}
