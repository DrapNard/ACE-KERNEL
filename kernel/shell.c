...
void shell_execute_command(char* command) {
    ...
    char* argv[MAX_ARGS];
    int argc = shell_parse_command(command, argv);
...
int cmd_ls(int argc, char* argv[]) {
    (void)argc;
    (void)argv;
    vga_print("Contenu du repertoire:\n");
    vga_print("  home/\n");
    vga_print("  tmp/\n");
    vga_print("  etc/\n");
    vga_print("  bin/\n");
...
int cmd_cat(int argc, char* argv[]) {
    ...
    vga_print("Contenu de ");
    vga_print(argv[1]);
    vga_print(":\n");
    vga_print("Hello from ACE filesystem\n");
    return 0;
}
...
int cmd_mem(int argc, char* argv[]) {
    ...
    vga_print("Utilisation memoire:\n");
    vga_print("  Total: 32 MB\n");
    vga_print("  Utilisee: 4 MB\n");
    vga_print("  Libre: 28 MB\n");
    vga_print("  Kernel: 2 MB\n");
    return 0;
}
